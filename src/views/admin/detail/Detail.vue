<template>
  <a-header>
    <template #default>
      <el-button type="primary" size="small" @click="$utils.changeRoute(`/admin/list/${pid}`)"> 上一页 </el-button>
    </template>
  </a-header>
  <div class="admin-note">
    <main>
      ...
      <el-input type="textarea" v-model="noteData.abstract" placeholder="请输入摘要"> </el-input>
